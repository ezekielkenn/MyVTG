...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void male(){
        gender = "m";
        genM.setBackgroundColor(getResources().getColor(R.color.m_white));
        genF.setBackgroundColor(Color.TRANSPARENT);

    }
    public void female(){
        gender = "f";
        genF.setBackgroundColor(getResources().getColor(R.color.m_white));
    ...
    public void checkEmpty(){
        ...
        }else alert("Invalid Email","Please make sure you entered a valid email address!","Okay");
    }
